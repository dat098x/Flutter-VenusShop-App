...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  Product _editedProduct = Product(id: null, title: '', description: '', price: 0.0, imageUrl: '');
  var _initValues = {
    'title': '',
    'price': '',
    'description': '',
  ...
  void _saveForm() {
    ...
    if (_editedProduct.id != null) {
      ...
      Provider.of<ProductsData>(context, listen: false).addProduct(_editedProduct);
    }
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if(value.length < 10) {
                    return 'Shoule be least 10 characters long';
                  }
                  return null;
                },
                onSaved: (value) {
